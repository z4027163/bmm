#ifndef PLOTCLASSNEW_h
#define PLOTCLASSNEW_h
...
// ----------------------------------------------------------------------
class plotClassnew: public TObject {

public :
  plotClassnew(std::string dir = "results",
	    std::string files = "plotClassnew.files",
	    std::string cuts = "nada",
	    std::string setup = "",
	    int year = 0);
  virtual        ~plotClassnew();
  ...
  TChain*        getChain(std::string ds, std::string dir = "", std::string mode = "");//added by me
  virtual void   setupTree(TTree *t, std::string mode = "");
  virtual void   setupTreeChain(TChain *t, std::string mode = "");
  ...
  TChain*        loadChain(std::string afiles);
