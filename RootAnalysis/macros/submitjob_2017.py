...
error                 = logs/job_2017_$(Cluster)_$(Process).stderr
Output                = logs/job_2017_$(Cluster)_$(Process).stdout
Log                   = logs/job_2017_$(Cluster)_$(Process).log
...
fout = open("condor_sub17.txt","w")
fout.write(''.join(fileParts))
fout.close()
system('condor_submit condor_sub17.txt')
